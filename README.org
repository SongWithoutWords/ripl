...
# #+LATEX: rowcolors{1}{}{gray!15}
#+ATTR_LATEX: :caption \caption{Comparison of Various Constructs in ~ripl~ and C++} \rowcolors{1}{}{gray!15}
| Feature           | ~ripl~           | C++                                                                |
|-------------------+------------------+--------------------------------------------------------------------|
...
#+ATTR_LATEX: :placement [H] :caption \caption{Languages Sorted by Euclidean Distance from \texttt{ripl}, Calculated from Language Feature Table} \rowcolors{1}{}{gray!15}
