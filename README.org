...
3. The use of the compiler as the language specification reduces documentation overhead.

Many of the features described in this document, even some of those that appear in code listings, have not yet been implemented and as such have not yet been specified.
