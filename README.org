...
In order for a language to be pleasant to use, it needs to be ergonomic, concise, and intuitive, and I believe these goals are correlated and entwined. Although some people do not seem to take syntax seriously (I've heard it dismissed as superficial bike-shedding, or described as a "solved problem"), I'm inclined to agree with Simon Peyton Jones, when he wrote in a presentation about Haskell's design:
...
# When placed in perspective as the user interface of a language

Syntax does, I believe, warrant serious design and consideration. ~ripl~'s syntax has changed dramatically since its inception. 

This has been part of an ongoing process of development and I hope improvement.
