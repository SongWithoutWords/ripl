...
Because ~ripl~ has a number of things in common with Lisp, including evaluation of expressions before run time, and a uniform syntax, it may be possible to experiment with adding some Lisp-style macros and metaprogramming features in future.
