...
In order for a language to be pleasant to use, it needs to be ergonomic, concise, and intuitive, and I believe these goals are correlated and entwined. To quote Simon Peyton Jones, one of the lead contributors to Haskell and GHC:
