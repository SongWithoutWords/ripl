...
#+LATEX_HEADER:  \setlist{noitemsep, topsep=2pt}
...
\titlespacing\subsection   {0pt} {4pt plus 4pt minus 2pt}{2pt plus 1pt minus 1pt}
\titlespacing\subsubsection{0pt} {4pt plus 4pt minus 2pt}{2pt plus 1pt minus 1pt}
...
2. ~ripl~'s syntax is Lisp-like, and as such:
   ...
   2. Symbols are separated by whitespace or parenthesis.
   ...
   5. Consequently, the language has no infix notation, operator precedence or associativity, an aspect of Lisp that is counter-intuitive for many (myself included), possibly because people are not accustomed to reading mathematical expressions without these conventions. I have two potential solutions in mind to provide infix notation, which are discussed in more detail in section X.
*************** TODO Provide a link to the section
*************** END
3. ~ripl~'s syntax includes some extensions over traditional Lisp syntax, inspired by [[https://sourceforge.net/p/readable/wiki/Home/][Readable Lisp S-expressions]]:
   ...
   2. Lines are continued to include all subsequent expressions at an increased level of indentation.
